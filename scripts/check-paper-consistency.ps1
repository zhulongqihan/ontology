...
foreach ($term in @('RQ1', 'RQ2', 'RQ3', 'RQ4', 'ontologyTypeId', 'Ontology version', 'definition hash', 'COMMITTED', 'PREPARED', 'A/B/C/D/E', 'RigidMappingBaseline', 'duration\_ns', 'BEGIN IMMEDIATE', '91 条', '演化能力矩阵', 'Replay')) {
